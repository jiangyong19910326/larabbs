/*1.5.4*/
(function () {
    var f = 0, l = [], n = {}, j = {}, a = {"<": "lt", ">": "gt", "&": "amp", '"': "quot", "'": "#39"},
...
(function (a) {
    a.runtimes.BrowserPlus = a.addRuntime("browserplus", {
        getFeatures: function () {
                ...
                g.bind("UploadFile", function (o, l) {
                    ...
                    if (c && /\.(png|jpg|jpeg)$/i.test(l.name)) {
                        BrowserPlus.ImageAlter.transform({
                            ...
                            actions: [{scale: {maxwidth: c.width, maxheight: c.height}}]
                        }, function (u) {
                            if (u.success) {
                                r(u.value.file)
                            }
            ...
            if (e) {
                e.init(function (l) {
                    var k = [{service: "Uploader", version: "3"}, {
                        service: "DragAndDrop",
                        version: "1"
                    }, {service: "FileBrowse", version: "1"}, {service: "FileAccess", version: "2"}];
                    if (c) {
...
(function (h, k, j, e) {
    ...
    j.runtimes.Html5 = j.addRuntime("html5", {
        getFeatures: function () {
            ...
            p.bind("Init", function (w) {
                ...
                G.innerHTML = '<input id="' + p.id + '_html5"  style="font-size:999px;overflow:hidden" type="file" accept="' + C.join(",") + '" ' + (p.settings.multi_selection && p.features.multi_selection ? 'multiple="multiple"' : "") + " />";
                G.scrollTop = 100;
                ...
                if (F) {
                    var z = w.settings.browse_button_hover, A = w.settings.browse_button_active,
    ...
    function f(s) {
        var u = {
            ...
            65517: {app: "IPTC", name: "APP13", signature: "Photoshop 3.0\0"}
        }, t = [], r, n, p = e, q = 0, o;
        r = new b();
        r.init(s);
        if (r.SHORT(0) !== 65496) {
    ...
    b.runtimes.Html4 = b.addRuntime("html4", {
        getFeatures: function () {
            ...
            f.bind("Init", function (p) {
                var j = a.body, n, h = "javascript", k, x, q, z = [], r = /MSIE/.test(navigator.userAgent), t = [],
                    m = p.settings.filters, o, l, s, w;
