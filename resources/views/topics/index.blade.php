    ...
    <div class="col-md-10 col-md-offset-1">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h1>
                    <i class="glyphicon glyphicon-align-justify"></i> 话题
                    <a class="btn btn-success pull-right" href="{{ route('topics.create') }}"><i class="glyphicon glyphicon-plus"></i> 创建</a>
                </h1>
            </div>
            ...
            <div class="panel-body">
                @if($topics->count())
                    ...
                    {!! $topics->render() !!}
                @else
                    <h3 class="text-center alert alert-info">暂时没有数据--</h3>
                @endif
            </div>
        </div>
    </div>
